...
import { encodeInlineI } from './capsule.js';
...
// @gcu/capsule and point at gentropic.org/ep with it. One click takes a
...
if (editLink && includeEdit) {
  ...
  encodeInlineI(text).then(capsule => {
    editLink.href = 'https://gentropic.org/ep#' + capsule;
